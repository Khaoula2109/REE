    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div>
          ...
          >
            <div className="text-center">
              <h1 className="text-3xl font-bold text-primary-600">REE</h1>
              <p className="text-xs text-gray-600">Energie & Eau</p>
            </div>
          </motion.div>
        ...
        <motion.div
          ...
          className="mt-8 bg-white rounded-xl shadow-2xl p-8"
        >
          ...
          <div className="mt-6">
            <p className="text-center text-xs text-gray-500">
              ...
              <br />
              <span className="font-semibold">admin@ree.ma / Admin@123</span> (Superadmin)
              <br />
              <span className="font-semibold">mbennani@ree.ma / User@123</span> (Utilisateur)
            </p>
          </div>
        </motion.div>
      </motion.div>
