...
const MobileLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-600 to-primary-800 flex flex-col justify-center px-6">
      <div className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-bold text-white mb-2">REE Mobile</h1>
        <p className="text-primary-100">Application de relevé de compteurs</p>
      </div>
      ...
      <p className="text-center text-primary-100 text-sm mt-6">
        © 2025 Rabat Energie & Eau - Tous droits réservés
      </p>
    </div>
  );
};
